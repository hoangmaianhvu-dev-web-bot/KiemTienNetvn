...
const ReferralPage: React.FC<ReferralPageProps> = ({ profile }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="text-center mb-16">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-white mb-6">Mời bạn bè, nhận hoa hồng <span className="text-blue-500">20%!</span></h1>
        <p className="text-gray-500 text-lg max-w-2xl mx-auto">Nhận ngay 20% hoa hồng trên mỗi nhiệm vụ bạn bè của bạn hoàn thành. Càng nhiều bạn bè, thu nhập thụ động càng lớn.</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16">
         ...
         <div className="bg-white rounded-[40px] p-10 shadow-2xl shadow-blue-500/10 flex flex-col justify-between space-y-12">
            <div>
               ...
               <div className="flex items-center gap-4">
                  ...
                  <button className="bg-blue-600 hover:bg-blue-700 text-white p-6 rounded-2xl shadow-xl shadow-blue-500/30 transition-all">
         ...
         <div className="bg-blue-600 rounded-[40px] p-10 shadow-2xl shadow-blue-500/30 text-white flex flex-col justify-between overflow-hidden relative">
            ...
            <div className="relative z-10">
               ...
               <p className="text-blue-100 text-lg leading-relaxed opacity-90 mb-12">Khi đạt 100 lượt giới thiệu hoạt động, bạn sẽ được nâng cấp lên <span className="text-white font-black underline underline-offset-4 decoration-white/30">Đối tác Vàng</span> với hoa hồng 30% và rút tiền ưu tiên.</p>
            </div>
            ...
            <div className="relative z-10">
               ...
               <div className="h-2 w-full bg-black/20 rounded-full overflow-hidden">
                  <div className="h-full bg-white transition-all duration-1000" style={{width: '5%'}}></div>
               </div>
            </div>
         </div>
      </div>
      ...
      <div className="bg-white rounded-[40px] p-12 md:p-20 shadow-2xl shadow-blue-500/5">
         ...
         <div className="grid md:grid-cols-3 gap-16 relative">
            ...
            {[
              ...
              { num: '03', title: 'Nhận hoa hồng', desc: 'Hệ thống tự động cộng tiền vào tài khoản của bạn.' }
            ].map((step, i) => (
